...
public class BackInBlack {
	...
	private static long solve(int n, char[] cStates, int m, int[] queries) {
		int[] states = new int[n];
		for (int i = 0; i < n; i++) {
			states[i] = cStates[i] - '0';
		}
...
//		System.out.println(Arrays.toString(states));
	...
	private static void flip(int n, int[] states, int q) {
		for (int i = q; i <= n; i += q) {
