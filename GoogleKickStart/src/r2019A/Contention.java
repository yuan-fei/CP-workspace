...
public class Contention {
	...
	private static int solve(int n, int q, int[][] req) {
		RangeUpdateRangeQueryTree st = new RangeUpdateRangeQueryTree(n + 1);
		for (int i = 0; i < req.length; i++) {
			st.increase(req[i][0], req[i][1], 1);
		}
		return 0;
	}
